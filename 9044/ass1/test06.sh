...
echo -e "\033[32m========Testing start: test for rm,show========\033[0m"
...
./legit-show :e >> output
./legit-show 0:e >> output
./legit-show 1:e >> output
./legit-show 2:e >> output
./legit-show 3:e >> output
./legit-add e  >> output 
./legit-commit -m e >> output 
...
rm e
./legit-add d >> output
./legit-commit -m delete-e >> output 
./legit-show 4:e >> output
./legit-show 4:d >> output

./legit-add e >> output
./legit-commit -m delete-e >> output 
./legit-show 5:d >> output
./legit-show 5:e >> output
./legit-show :e >> output
...
echo "legit-show: error: 'e' not found in commit 0" >>sample
echo "legit-show: error: 'e' not found in commit 1" >>sample
echo "legit-show: error: 'e' not found in commit 2" >>sample
echo "legit-show: error: unknown commit '3'" >>sample
...
echo "d" >>sample
echo "legit-show: error: 'e' not found in commit 5" >>sample
echo "legit-show: error: 'e' not found in index" >>sample
